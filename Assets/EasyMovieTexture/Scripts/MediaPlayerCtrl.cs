...
//			}
...
#if (UNITY_IPHONE  || UNITY_TVOS || UNITY_ANDROID) && !UNITY_EDITOR
...
#elif UNITY_IPHONE  || UNITY_TVOS || UNITY_ANDROID
	...
	public unsafe bool Call_Load(string strFileName, int iSeek)
	{
